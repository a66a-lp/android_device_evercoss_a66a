...
TARGET_PREBUILT_KERNEL := device/evercoss/a66a/kernel
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board 1441186574
BOARD_CUSTOM_BOOTIMG := true
TARGET_PREBUILT_RECOVERY_KERNEL := device/evercoss/a66a/kernel

TARGET_RECOVERY_FSTAB := device/evercoss/a66a/rootdir/root/fstab.mt6582

TARGET_OTA_ASSERT_DEVICE := P6_Life,a66a,"Evercoss A66A"
# TWRP
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/evercoss/a66a/bluetooth

# EGL settings
BOARD_EGL_CFG := device/evercoss/a66a/rootdir/system/lib/egl/egl.cfg
...
# GPS
TARGET_SPECIFIC_HEADER_PATH := device/evercoss/a66a/include
